...
hero:
  name: "EasyDecisions"
  text: "Type-safe, Fluent Decision Engine for .NET"
  tagline: Replace complex, hard-to-maintain DMN XML files with pure, compile-time checked C# code.
  actions:
    - theme: brand
      text: Get Started
    ...
    - theme: alt
      text: View on GitHub
      link: https://github.com/mmonteiroc/easy-decisions
